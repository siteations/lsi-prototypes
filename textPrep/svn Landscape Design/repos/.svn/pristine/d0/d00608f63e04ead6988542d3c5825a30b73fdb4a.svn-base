jQuery(function($) {
    ...
    function loadManifests(cb) {
		var manifests = 'http://community.village.virginia.edu/cultural_landscapes/uv/manifests.json';
		if (getUrlParameter('juel') != null) {
			manifests = 'manifests-juel.json';
		}
    ...
    function init() {
        if (isLocalhost){
            ...
            $('body').append('<script type="text/javascript" id="embedUV" src="http://community.village.virginia.edu/cultural_landscapes/uv/uv/lib/embed.js"><\/script>');
        }
